      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mt-16 pt-12 border-t border-gray-700">
          ...
          <div className="flex justify-center gap-4">
            <button onClick={() => alert("Social media links will be updated soon")} className="bg-red-600 hover:bg-red-700 active:scale-95 px-6 py-2 font-semibold active:scale-95 transition duration-300 rounded">
              Facebook
            </button>
            <button onClick={() => alert("Social media links will be updated soon")}className="bg-red-600 hover:bg-red-700 active:scale-95 px-6 py-2 font-semibold active:scale-95 transition duration-300 rounded">
              Instagram
